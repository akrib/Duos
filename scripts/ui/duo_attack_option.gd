...
signal option_hovered(partner: BattleUnit3D)  # ✅ MODIFIÉ : Envoie le partenaire
...
var partner_unit: BattleUnit3D = null  # ✅ NOUVEAU : Référence au partenaire
...
func _on_mouse_entered() -> void:
	if partner_unit:
		option_hovered.emit(partner_unit)  # ✅ Animation bounce au survol
