...
func _ready() -> void:
	...
	EventBus.safe_connect("game_loaded", _on_game_loaded)
...
func _on_start_pressed() -> void:
	...
	# Notification
	EventBus.notify("Démarrage d'une nouvelle partie...", "info")
...
func _on_continue_pressed() -> void:
	...
	EventBus.notify("Chargement de la partie...", "info")
	GameManager.load_game("auto_save")
...
func _on_options_pressed() -> void:
	...
	EventBus.notify("Options (à implémenter)", "info")
...
func _on_credits_pressed() -> void:
	...
	EventBus.notify("Crédits (à implémenter)", "info")
	
	# TODO: Quand la scène crédits sera créée
	# EventBus.change_scene(SceneRegistry.SceneID.CREDITS)
